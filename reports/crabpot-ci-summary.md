...
OpenClaw: openclaw/openclaw@main (2026.7.2, f5add8197fa9)
Status: PASS
...
| Execution pass              | 75                                                                        |
| Execution fail              | 0                                                                         |
| Execution blocked           | 23                                                                        |
| Windows portability risks   | 0                                                                         |
| Container portability risks | 0                                                                         |
| Jiti loader candidates      | 10                                                                        |
| Import loop                 | p50 106 ms / p95 106 ms / plugin delta RSS 1.3 MB / plugin delta CPU 5 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------ |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 130.4   | maxPeakRssMb regressed 65.30000000000001 over baseline |
