...
| Audit artifacts              | 6        |
| Profile artifacts            | 1        |
| Captured registrations/hooks | 66       |
| Audit findings               | 3        |
| Execution wall               | 38242 ms |
| Max peak RSS                 | 377.1 MB |
| Max CPU estimate             | 8771 ms  |
| Pass                         | 75       |
| Fail                         | 0        |
| Blocked                      | 23       |
...
| openclaw-beta          | profile   | pass               | -                                                   | 69 steps / 38242 ms / 377.1 MB | .crabpot/results/openclaw-beta/execution-profile.json                                                                                                       |
| openclaw-qqbot         | capture   | captured           | index.ts                                            | 7 captured                     | .crabpot/results/openclaw-qqbot/cold-import-extension-openclaw-qqbot-plugins-openclaw-qqbot-crabpot-package-index-ts.capture.json                           |
| openclaw-qqbot         | synthetic | captured           | .crabpot/workspaces/openclaw-qqbot/index.ts         | 0 pass / 0 fail / 7 blocked    | .crabpot/results/openclaw-qqbot/cold-import-extension-openclaw-qqbot-plugins-openclaw-qqbot-crabpot-package-index-ts.synthetic.json                         |
...
| ------------- | ------- | ------- | -------- | ------------ | ----------------------------------------------- |
| openclaw-beta | install | 7997 ms | 377.1 MB | 8771 ms      | npm install --ignore-scripts --legacy-peer-deps |
| openclaw-beta | install | 4795 ms | 351.9 MB | 6302 ms      | npm install --ignore-scripts --legacy-peer-deps |
| openclaw-beta | install | 3501 ms | 257.7 MB | 3362 ms      | npm install --ignore-scripts --legacy-peer-deps |
| openclaw-beta | install | 3432 ms | 233.5 MB | 3275 ms      | npm install --ignore-scripts --legacy-peer-deps |
| openclaw-beta | install | 1956 ms | 238.6 MB | 2759 ms      | npm install --ignore-scripts --legacy-peer-deps |
