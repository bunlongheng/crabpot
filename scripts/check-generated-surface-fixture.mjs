...
function renderSdkImports(sdkExports) {
  // These must be runtime imports because Inspector intentionally ignores type-only SDK imports.
  return `// Generated by Crabpot. Do not edit by hand.
${sdkExports.map((specifier, index) => `import * as sdk${index} from ${JSON.stringify(specifier)};`).join("\n")}
